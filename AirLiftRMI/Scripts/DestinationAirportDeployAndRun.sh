...
sshpass -f password scp destinationRun.sh sd205@l040101-ws$1.ua.pt:AirLift/RMIProj/AirliftRMI
...
sshpass -f password ssh sd205@l040101-ws$1.ua.pt 'cd AirLift/RMIProj/AirliftRMI ; ./destinationRun.sh sd205'
